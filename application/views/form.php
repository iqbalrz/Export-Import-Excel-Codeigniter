    ...
    <div class="card">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <select name="gender"> 
              <option value="Female" <?php if(isset($data->gender)){if($data->gender=="Female") echo 'selected="selected"';}; ?> >Female</option>
              <option value="Male" <?php if(isset($data->gender)){if($data->gender=="Male") echo 'selected="selected"';}; ?> >Male</option>
            </select>
          </td>
        </tr>
        <tr>
